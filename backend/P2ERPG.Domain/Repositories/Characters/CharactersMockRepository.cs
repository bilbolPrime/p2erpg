...
namespace BilbolStack.Boonamai.P2ERPG.Domain.Repositories.Characters
{
    public class CharactersMockRepository : CharactersRepository
    {
        ...
        public override async Task<Character> GetAsync(int id, long mintId)
        {
            return new Character() { Id = id, MintId = mintId, Agility = 1, Concentration = 2, Endurance = 5, HP = 5, Speed = 2, Strength = 3, Type = id % 3, Wallet = mintId.ToString()};
        }
        ...
        public override async Task<IEnumerable<Character>> GetAsync(string wallet)
        {
            ...
            {
                new Character() { Agility = 1, Concentration = 2, Endurance = 5, HP = 5, Speed = 2, Strength = 3, Type = 0, Wallet = wallet, Level = 1 },
                new Character() { Agility = 2, Concentration = 5, Endurance = 15, HP = 35, Speed = 42, Strength = 13, Type = 1, Wallet = wallet, Level = 2 },
                new Character() { Agility = 2, Concentration = 5, Endurance = 15, HP = 35, Speed = 42, Strength = 13, Type = 2, Wallet = wallet, Level = 3 }
            };
        }
